...
public class JogadorComportamento : MonoBehaviour {
    ...
    /// <summary>
    /// Uma referencia para o comportamento RigidBody
    /// </summary>
    private Rigidbody rb;

    [Tooltip("A velocidade que a bola ira esquivar para os lados")]
    [Range(0, 10)]
    public float velocidadeEsquiva = 5.0f;

    [Tooltip("Velocidade com qual a bola ira se deslocar para a frente")]
    [Range(0, 10)]
	...
	void Update () {
        ...
        //Aplicar uma forca para que a bola se desloque
